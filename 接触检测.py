...
class ProximityDetector:
    def __init__(self):
        ...
        self.fixed_points = {
            ...
            "电压电流旋钮": {"position": (1.56, 1.5, 0.37), "threshold": 0.5},
...
if __name__ == "__main__":
    ...
    # 处理输入文件并生成输出文件
    input_file = r"d:\QTproject\hr_rtls_pc-master\Logs\1.21交职UWB报警实验\双手4，阈值0.4\双手轨迹4.csv"
    output_file = r"d:\QTproject\hr_rtls_pc-master\Logs\1.21交职UWB报警实验\双手4，阈值0.4\接触检测结果4.1.csv"
